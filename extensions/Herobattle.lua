...
["cv:Rean"] = "内山昂辉",
["huanqi"] = "唤骑",
[":huanqi"] = "主将技，此人物牌减少一个阴阳鱼。<font color=\"green\"><b>每回合限一次，</b></font>当你需要使用或打出一张【杀】时，你可以变更副将视为你使用或打出了一张【杀】。",
["rwuren"] = "无仞",
...
["eryu"] = "二羽",
    ...
    ["nizhuan"] = "逆转",
	[":nizhuan"] = "主将技，此人物牌减少一个阴阳鱼。<font color=\"green\"><b>每回合限一次，</b></font>你可以将一张“证据”当做“异议”使用或打出，若你以此法使用牌的花色与被响应的【杀】牌颜色相同，此异议结算后目标视为对使用者使用一张名称相同的【杀】。",
	["yanshen"] = "延审",
...
["Oumashu"] = "樱满集",
  ...
  ["wangguo"] = "王国",
  [":wangguo"] = "主将技，此人物牌减少一个单独的阴阳鱼。你使用虚空时可以额外指定一名其他势力相同的角色为目标；你使用虚空指定势力相同的角色为目标时，可以失去1点体力，执行下列一项：1，令其回复1点体力；2，其摸2张牌，；3，弃置其判定区一张牌。",
  ["void_draw"] = "令目标摸两张牌",
