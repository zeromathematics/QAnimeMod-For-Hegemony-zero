...
["Sakunahime"] = "佐久名",
  ...
  ["yixins"] = "遗信",
  [":yixins"] = "当你受到伤害时，摸x张牌并将至多等量牌暗置于一名其他角色人物牌上作为“遗信”(x为你已损失体力值，至少1），若你进入濒死后未被救回，该角色可以立即获得人物牌上所有“遗信”。<font color=\"orange\">永久效果：一名其他角色摸牌阶段开始时，获得人物牌上的所有“遗信”，本回合手牌上限+1。</b></font>",
