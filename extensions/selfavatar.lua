...
sgs.LoadTranslationTable{
  ...
  ["cv:Mizuwaza"] = "",
  ["Mizuwazaskill"] = "敏识",
  [":Mizuwazaskill"] = "因为在低潮时期分别遇见了三国杀和LoveLive，从而成为这两个企划的忠实粉丝。在LL当中最喜欢樱内梨子，把她当做梦中情人。虽然在2022年4月24日才加入动漫杀大家庭，但是论认真和热忱的程度却丝毫不逊色于各位前辈们，尤其是以成功设计出乙坂有宇而自豪。希望以后能继续为动漫杀的进一步发展而尽绵薄之力，添砖加瓦~",
