...
sgs.LoadTranslationTable{
  ...
  ["#jiesiThrow"] = "解思：弃牌",
  ["tongzhou"] = "同舟",
  [":tongzhou"] = "<font color=\"green\"><b>每回合限一次，</b></font>当你的牌因弃置而进入弃牌堆后，你可以预知3。",
  ["$tongzhou1"] = "我们好像心意相通了。",
  ...
  ["$aiwen2"] = "七夕的故事虽美……但却令人伤感……因为我非常理解想见又不得见的心情……",
