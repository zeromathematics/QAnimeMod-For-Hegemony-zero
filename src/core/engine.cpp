...
{
    return QSanVersionNumber(3, 0, 1);
}
#endif
...
QString Engine::getRandomGeneralName() const
{
    ...
    while (general->getKingdom() == "programmer" || general->objectName() == "Beast_Titan" || general->objectName() == "Cart_Titan" || general->objectName() == "Pure_Titan" || general->objectName() == "Founding_Titan")  //exclude unsightful pictures
