...
void Settings::init()
{
    ...
    EventcardMode = value("EventcardMode", false).toBool();
    ...
    RewardTheFirstShowingPlayerDetail = value("RewardTheFirstShowingPlayerDetail", "Draw2Cards").toString();
    ...
    BanKingdomModeDetail = value("BanKingdomModeDetail", "Random").toString();
    ...
    if (forbid_packages.isEmpty()) {
        forbid_packages << "test" << "jiange-defense" << "maria-battle";
