...
public:
    ...
    virtual const Card *askForIgiari(const Card *basic, ServerPlayer *from, ServerPlayer *to, bool positive) = 0;
...
public:
    ...
    virtual const Card *askForIgiari(const Card *basic, ServerPlayer *from, ServerPlayer *to, bool positive);
