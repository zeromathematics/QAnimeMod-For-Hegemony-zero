...
public:
    ...
    void doCommandForcely(const QString &reason, int index, ServerPlayer *source, ServerPlayer *dest = NULL);
    ...
    void hideGeneralWithoutChangingRole(bool head_general = true);
