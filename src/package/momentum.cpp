...
MomentumPackage::MomentumPackage()
    : Package("momentum")
{
    skills<<new Xunxun<<new Wangxi<<new Hengjiang<<new HengjiangDraw<<new HengjiangFail<<new HengjiangMaxCards
         <<new Mashu("madai")<<new Qianxi<<new QianxiClear<< new Guixiu<<new Cunsi
        <<new Jiang<<new Yingyang<<new Hunshang<<new HunshangRemove<<new Duanxie<<new Fenming
       <<new Hengzheng<<new Baoling<<new Chuanxin<<new Fengshi<<new Wuxin<<new Hongfa<<new Wendao<<new HongfaClear;
