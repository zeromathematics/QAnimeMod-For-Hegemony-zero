...
FormationPackage::FormationPackage()
    : Package("formation")
{
    skills << new Tuntian << new TuntianPostpone << new TuntianGotoField << new TuntianDistance << new Jixi << new Ziliang
           << new Huyuan << new Heyi << new Tiaoxin << new Yizhi << new Tianfu
           << new Shengxi <<new Shoucheng
           << new ShengxiClear
           << new Shangyi << new Niaoxiang
           << new Yicheng
           << new Qianhuan
           <<new Zhendu<<new Qiluan
          <<new Zhangwu << new Zhangwu_Draw
         << new Shouyue << new Jizhao;
