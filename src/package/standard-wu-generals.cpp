...
{
    skills<<new Zhiheng<<new Qixi<<new Keji<<new Kurou<<new Yingzi
         <<new Fanjian<<new Guose<<new Liuli<<new Haoshi<<new Dimeng
        <<new Qianxun<<new Duoshi<<new Jieyin<< new Xiaoji<<new Yinghun
       <<new Tianxiang<< new Hongyan<<new Tianyi<<new Buqu<<new TianxiangDraw
      <<new TianyiTargetMod<<new BuquClear<< new BuquRemove<< new HaoshiGive
     <<new Zhijian<<new Guzheng<< new Duanbing<<new Fenxun;
