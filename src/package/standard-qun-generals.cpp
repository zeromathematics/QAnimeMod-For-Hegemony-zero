...
{
    skills << new Jijiu<<new Qingnang<<new Wushuang<<new Lijian<<new Biyue
           <<new Luanji<<new Shuangxiong<<new Wansha<<new Luanwu<< new Weimu
          <<new Mashu("pangde")<<new Mengjin<<new Leiji<<new Guidao
         << new Beige <<new Duanchang <<new Mashu("mateng") << new Xiongyi
          <<new Mingshi << new Lirang << new Shuangren << new Sijian<< new Suishi
          << new Kuangfu << new Qingcheng << new Huoshui;
