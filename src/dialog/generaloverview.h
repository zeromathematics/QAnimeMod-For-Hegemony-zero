...
public slots:
    ...
    void startSearch(bool include_hidden, const QString &anime, const QString &nickname, const QString &name, const QStringList &genders, const QStringList &kingdoms, int lower, int upper, const QStringList &packages);
