...
QWidget *ServerDialog::createAdvancedTab()
{
    ...
    eventcard_mode_checkbox = new QCheckBox(tr("Enable eventcard"));
    eventcard_mode_checkbox->setChecked(Config.EventcardMode);
...
bool ServerDialog::config()
{
    ...
    Config.EventcardMode = eventcard_mode_checkbox->isChecked();
    ...
    Config.setValue("EventcardMode", Config.EventcardMode);
