...
function SmartAI:printAll(self, player, intention)
	...
	self.room:writeToConsole(self:getHegGeneralName(player) .. math.floor(intention * 10) / 10
							.. " R" .. math.floor((sgs.ai_loyalty["magic"][name] or 0) * 10) / 10
							.. " G" .. math.floor((sgs.ai_loyalty["game"][name] or 0) * 10) / 10
							.. " B" .. math.floor((sgs.ai_loyalty["science"][name] or 0) * 10) / 10
							.. " Q" .. math.floor((sgs.ai_loyalty["real"][name] or 0) * 10) / 10
