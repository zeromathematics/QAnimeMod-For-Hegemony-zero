...
CommonTranslationTable = {
	...
	["#NullificationDetails"] = "【<font color=\"yellow\"><b>金色宣言</b></font>】的目标是 %from 对 %to 的锦囊 【%arg】",
	["#HegNullificationDetails"] = "【<font color=\"yellow\"><b>论破</b></font>】的目标是 %from 对 %to 的锦囊 【%arg】",
	["#HegNullificationEffect"] = "【<font color=\"yellow\"><b>论破</b></font>】生效， 目标是 %from 对 %to 的锦囊 【%arg】",
	["#HegNullificationSelection"] = "%from 选择了该【<font color=\"yellow\"><b>论破</b></font>】为 %arg" ,
