...
return {
	...
	["Blade"] = "楼观剑",
	[":Blade"] = "装备牌·武器\n\n攻击范围：3\n技能：锁定技，你使用【杀】时，目标角色不能明置武将牌直到此次使用牌结算完毕。",
	...
	["IronArmor"] = "湛蓝",
	[":IronArmor"] = "装备牌·防具\n\n技能：每当你成为【天破壤碎】、【异端审判】或火【杀】的目标时，你取消自己；若你是小势力角色，你的武将牌不能被横置。",
	...
	["JadeSeal"] = "圣杯",
	[":JadeSeal"] = "装备牌·宝物\n\n技能：锁定技，若你有明置的武将牌，则：你所属的势力成为唯一的大势力；摸牌阶段摸牌时，你额外摸一张牌；出牌阶段开始时，你视为使用一张【心灵读取】。",
	...
	["@threaten_emperor"] = "受到【SOS社团活动】影响，你可以弃置一张牌，获得一个额外的回合",

	["imperial_order"] = "令咒",
	[":imperial_order"] = "锦囊牌\n\n使用时机：出牌阶段。\n使用目标：所有没有势力的角色。\n作用效果：目标角色选择一项：1. 明置一张武将牌，然后摸一张牌；2. 弃置一张装备牌；3. 失去1点体力。\n\n※若此牌未因使用此效果而进入弃牌堆时，则改为将此牌移出游戏，然后于此回合结束时视为对所有未确定势力的角色使用此牌。",
	["@imperial_order-equip"] = "受到【令咒】的影响，你需要弃置一张装备牌，或点“取消”选择以下一项：<br />1. 明置一张武将牌，然后摸一张牌<br />2. 失去1点体力",
