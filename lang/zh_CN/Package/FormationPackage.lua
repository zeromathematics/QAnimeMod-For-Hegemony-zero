...
return {
	...
	["DragonPhoenix"] = "干将莫邪",
	[":DragonPhoenix"] = "装备牌·武器\n\n攻击范围：2\n技能：每当你使用【杀】指定一个目标后，你可以令其弃置一张牌；每当被你使用【杀】杀死的角色死亡后，若你不为野心家且你的势力是角色最少的势力，你可以令扮演其的玩家选择是否从未使用的武将牌中选择与你势力相同的一张武将牌重新加入游戏。",
	["@dragonphoenix-discard"] = "受到【干将莫邪】效果影响，请弃置一张牌",
