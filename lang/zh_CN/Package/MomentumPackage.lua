...
return {
	...
	["PeaceSpell"] = "夜天之书",
	[":PeaceSpell"] = "装备牌·防具\n\n技能：锁定技，每当你受到属性伤害时，你防止此伤害；锁定技，与你势力相同的角色的手牌上限+X（X为与你势力相同的角色数）；锁定技，每当你失去装备区里的【夜天之书】后，你失去1点体力，然后摸两张牌。",
	["#PeaceSpellNatureDamage"] = "【<font color=\"yellow\"><b>夜天之书</b></font>】的效果被触发，防止了 %from 对 %to 造成的 %arg 点 %arg2 伤害" ,
	["#PeaceSpellLost"] = "%from 失去了装备区中的【<font color=\"yellow\"><b>夜天之书</b></font>】，须失去1点体力并摸两张牌" ,
}
